...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('old_shorten_links', sa.Column('project', sa.String(length=255), nullable=True))
    op.add_column('shorten_links', sa.Column('project', sa.String(length=255), nullable=True))
