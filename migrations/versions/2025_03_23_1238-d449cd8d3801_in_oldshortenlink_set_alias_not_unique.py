...
def upgrade() -> None:
    """Upgrade schema."""
    op.drop_constraint('old_shorten_links_alias_key', 'old_shorten_links', type_='unique')


def downgrade() -> None:
    """Downgrade schema."""
    op.create_unique_constraint('old_shorten_links_alias_key', 'old_shorten_links', ['alias'])
